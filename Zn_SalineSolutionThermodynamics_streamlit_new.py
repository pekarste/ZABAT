...
class Zn_solution:
    ...
    def plot_Zn_species_distribution(self):
        ...
        plt.plot(self.pH_range, self.Zn_2*np.ones(len(self.pH_range)), 'k--')
    ...
    def plot_carbonate_species_distribution(self):
        ...
        plt.plot(self.pH_range, self.c_K2CO3*np.ones(len(self.pH_range)), 'k--')
    ...
    def plot_fluorine_species_distribution(self):
        ...
        plt.plot(self.pH_range, self.concentration_matrix[7, : ], linewidth = 3)
        plt.plot(self.pH_range, self.c_KF*np.ones(len(self.pH_range)), 'k--')
