...
pZn_threshold = (deltaG_new_T['deltaG_IX-eps']-deltaG_new_T['deltaG_X'])/(constants['R']*T*np.log(10))
print(pZn_threshold)
## Plotting
...
for i in range(len(pZn_values)):
    ...
    # # Zn^2+ --> Zn(OH)2
    # pHVIII_eps = 14 + deltaG_Vant_Hoff['deltaG_VIII-eps']/(2*constants['R']*T*np.log(10)) + constants_p['pZn']/2 - 0*constants_p['pZnOH2']/2
    # x_Zn2_ZnOH2.append(pHVIII_eps)
    ...
    # Zn^2+ --> Zn(OH)2
    pHVIII_eps = 14 + deltaG_new_T['deltaG_VIII-eps']/(2*constants['R']*T*np.log(10)) + constants_p['pZn']/2 - 0*constants_p['pZnOH2']/2
    x_Zn2_ZnOH2.append(pHVIII_eps)
    print(pHVIII_eps)
